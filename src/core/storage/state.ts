...
export async function getAllExtensionState(context: vscode.ExtensionContext) {
	...
	const [
		...
		getWorkspaceState(context, "vsCodeLmModelSelector") as Promise<any | undefined>,
		...
		getWorkspaceState(context, "previousModeVsCodeLmModelSelector") as Promise<any | undefined>,
