...
// However, the Language Model API types are now included in the standard VSCode types, so we only need
// to extend the selector interface to match our custom types.
