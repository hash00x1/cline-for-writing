---
title: "Installing Cline Writer"
description: "Cline Writer is a VS Code extension that brings AI-powered writing assistance directly
...
Follow these steps to get Cline Writer up and running:

1.  **Open VS Code:** Launch the VS Code application.

    > ⚠️ **Note:** If VS Code shows "Running extensions might...", click "Allow".

2.  **Open Your Writing Project Folder:** In VS Code, open or create a folder for your writing project (academic paper, screenplay, novel, etc.).
...
4.  **Search for 'Cline Writer':** In the Extensions search bar, type `Cline Writer`.

<Frame caption="VS Code marketplace with Cline Writer extension ready to install">
	<img
		src="https://storage.googleapis.com/cline_public_images/docs/assets/image%20(20).png"
		alt="VS Code marketplace showing Cline Writer extension"
	/>
</Frame>

1. **Install the Extension:** Click the "Install" button next to the Cline Writer extension.
2. **Open Cline Writer:**
    - Click the Cline Writer icon in the Activity Bar.
    - Or, use the command palette (`Ctrl/Cmd + Shift + P`) and type "Cline Writer: Open In New Tab" for a better view.
3. **Troubleshooting:** If you don't see the Cline Writer icon, try restarting VS Code.

> ✅ **Pro Tip:** You should see the Cline Writer chat window appear in your VS Code editor!
...
3. Search for "Cline Writer".
4. Select "Cline Writer" by saoudrizwan and click **Install**.
5. Reload if prompted.

### 👤 Creating Your Cline Writer Account
