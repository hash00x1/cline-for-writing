The Auto Approve menu lets you set fine-grained permissions on what you allow Cline Writer to do in an automated way.
...
By default, Cline Writer will ask for your permission before calling any tool, including reading or writing files.

If you want to allow Cline Writer to do something without asking, you can set the Auto Approve permission for that tool.

## Permission Options

-   **Read project files**

    -   Allows Cline Writer to read files within your current workspace without asking
    -   **Read all files**
