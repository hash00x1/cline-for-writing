Cline Writer Rules allow you to provide Cline Writer with system-level guidance for your writing projects. Think of them as a persistent way to include context, style preferences, and writing guidelines for your projects or globally for every conversation.
...
You can also have Cline Writer create a rule for you by using the [`/newrule` slash command](/features/slash-commands/new-rule) in the chat.

```markdown Example Cline Writer Rule Structure [expandable]
