...
Checkpoints automatically save snapshots of your workspace after each step in a writing task. This feature lets you track changes, roll back when needed, and experiment confidently with your writing projects.

## How Checkpoints Work

Cline Writer creates a checkpoint after each tool use (file edits, commands, etc.). These checkpoints:
...
For example, if you're working on a research paper and Cline Writer makes multiple document changes, each change creates a checkpoint. This means you can review each modification and, if needed, roll back to any point without affecting your main Git repository.
